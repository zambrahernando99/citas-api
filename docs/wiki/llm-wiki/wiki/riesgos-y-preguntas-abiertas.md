...
- **PREGUNTA ABIERTA:** vencimiento, recuperación ante fallo y visibilidad de slots retenidos en `REQUESTED` y `PENDING`.
- **PREGUNTA ABIERTA:** mecanismo de concurrencia verificable para reservas simultáneas.
- **PREGUNTA ABIERTA:** TTL, rotación/revocación de refresh tokens y comportamiento de sesiones simultáneas.
